...
function open_embeddedform(form) {
   ...
   var form_url = "https://demo.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=de5bbec1-7fbf-46a9-8053-7fb8cdcbf428";
    form_url += "&Customer_UserName=" + $("name").value;
    form_url += "&Customer_Email=" + $("email").value;
	form_url += "&Phone=" + $("phone").value;
