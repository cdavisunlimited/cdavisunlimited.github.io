...
function open_embeddedform(form) {
   ...
   var form_url = "https://demo.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=6ec0c3c9-046d-41ca-ab06-a3fc65940434";
    form_url += "&Internal Signer_UserName=Coleman Davis";
    form_url += "&Internal Signer_Email=coleman.davis@docusign.com";
	form_url += "&External Signer_UserName=" + $("name").value;
    form_url += "&External Signer_Email=" + $("email").value;
	form_url += "&PName=" + $("pname").value;
